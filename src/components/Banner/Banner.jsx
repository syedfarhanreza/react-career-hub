    ...
    return (
        <div className=" bg-white mb-10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={profile} className="max-w-lg rounded-lg" />
                <div className='mr-24'>
                    <h1 className="text-5xl font-bold">One Step <br /> Closer to Your <br /> <span className='text-[#c47efe]'>Dream Job</span></h1>
